  ...
  return (
    <>
      ...
      <section className="bg-ink-50 py-16 md:py-24">
        <Container>
          <h2 className="text-center font-heading text-2xl font-bold text-ink-900 md:text-3xl">
            主なサービス内容
          </h2>
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {services.map(({ icon: Icon, title, description }) => (
              <div key={title} className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-ink-100">
      ...
      <section className="bg-white py-16 md:py-24">
        <Container className="max-w-3xl">
          <h2 className="font-heading text-2xl font-bold text-ink-900 md:text-3xl">お問い合わせ</h2>
          <p className="mt-4 leading-relaxed text-ink-600">

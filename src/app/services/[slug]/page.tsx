    ...
    <>
      ...
      <section className="bg-white py-16 md:py-24 dark:bg-ink-900">
        <Container className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1fr]">
          <div>
            <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-50 text-brand-600 dark:bg-ink-800 dark:text-brand-400">
              <Icon name={service.icon} className="h-7 w-7" />
            </span>
            <h2 className="mt-6 font-heading text-2xl font-bold text-ink-900 md:text-3xl dark:text-white">
              What&apos;s Included
            </h2>
            <ul className="mt-6 space-y-4">
              {service.benefits.map((benefit) => (
                <li key={benefit} className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-accent-50 text-accent-600 dark:bg-accent-500/10 dark:text-accent-500">
                    <Check className="h-4 w-4" />
                  </span>
                  <span className="text-sm leading-relaxed text-ink-600 md:text-base dark:text-ink-300">{benefit}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h2 className="font-heading text-2xl font-bold text-ink-900 md:text-3xl dark:text-white">Our Process</h2>
            <div className="mt-8">
